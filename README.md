...
## Conseils pour le rendu GitHub

Pour chaque procédure de test, il est conseillé d’écrire :

1. L’objectif du test.
2. Les commandes exécutées.
3. Le résultat attendu.
4. Une capture d’écran ou un extrait de sortie terminal si cela est demandé.

Cette méthode rend le README plus professionnel, plus lisible, et surtout plus facile à corriger dans un contexte pédagogique ou d’évaluation technique.